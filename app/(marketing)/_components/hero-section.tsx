...
import KindleLogo from "@/public/companies/kindle.png";
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect
                  ...
                  Teamflow organize conversations into channels with threads, is realtime and uses AI to keep teams in sync.
                </TextEffect>
